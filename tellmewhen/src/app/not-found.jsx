export default function Page()
{
    return (
        ...
        <div className="w-[100%] fixed top-[50%] h-[100%] bg-[#F5F5F5]">
            <div className="translate-y-[-50%] justify-center bg-[#F5F5F5]">
                ...
                <h1 className="flex justify-center text-stone-500 text-center font-semibold text-[20px] mx-auto w-full">404 - Page Not Found</h1>
            </div>
        </div>
        </div>
    );
