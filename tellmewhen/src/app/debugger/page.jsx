    ...
    return (
        ...
        <span className="w-[90%] mx-auto mt-[10px] justify-center tablet1080:space-x-[25px] tablet1080:inline max-tablet1080:space-y-[15px] tablet1080:flex">
            ...
            <div className="mx-auto space-y-[10px] px-[20px] w-[90%] rounded-md py-[10px] bg-white shadow-lg">
                ...
                <Button className="w-[100%]" onClick={()=>{window.location.href="/debugger/chat/newuser"}}>Add New User</Button>
                <Button className="w-[100%]" onClick={()=>{window.location.href="/debugger/chat/newchannel"}}>Add New Channel/Chat</Button>

                <Button className="w-[100%]" onClick={()=>{window.location.href="/debugger/chat/business"}}>Business Chat Client</Button>
                <Button className="w-[100%]" onClick={()=>{window.location.href="/debugger/chat/user"}}>User Chat Client</Button>
