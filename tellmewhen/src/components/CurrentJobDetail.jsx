            ...
            <div className="bg-white w-1/3 rounded-lg shadow-lg p-6">
                ...
                <form>
                    ...
                    <div className="mb-6">
                        ...
                        <input type="date" id="deadline" className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100" value={tempData.deadline || ""} disabled={!isEditing} onChange={(e) => handleInputChange("deadline", e.target.value)} />
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <input type="text" id="status" className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100" value={tempData.status || ""} disabled={!isEditing} onChange={(e) => handleInputChange("status", e.target.value)} />
                    </div>
                    ...
                    <div className="flex justify-end space-x-4">
                        {!isEditing && (
                            <>
                                ...
                                <Button onClick={handleChange} variant="solid" color="primary" className="px-4 py-2">
                                    Change
                                </Button>
                            </>
                        )}
